...
<div class="col-md-12 well well-md">
    ...
    <div class="form-horizontal">    
        ...
        <div class="form-group">
            <label class="col-md-3 control-label">Confirmation du nouveau mot de passe : </label>
            <div class="col-md-6 col-md-3">
                <input type="password" name="cnpwd" ng-model="cnpwd" class="form-control" placeholder="Confirmer votre nouveau mot de passe" required>
            </div>
        </div>
